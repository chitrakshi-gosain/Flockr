...
def test_message_react_noerrors(initialise_user_data, initialise_channel_data):
    '''
...
def test_message_react_invalidreact(initialise_user_data, initialise_channel_data):
    '''
    test that message_react raises InputError
...
def test_message_react_twice(initialise_user_data, initialise_channel_data):
    '''
    test that message_react raises InputError
...
def test_message_react_notauth(initialise_user_data, initialise_channel_data):
    '''
